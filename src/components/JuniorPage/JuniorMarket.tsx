...
const JuniorMarket = () => {
  ...
  return (
    <div className="relative w-[393px] h-[351px] bg-white overflow-y-auto">
      {/* 타이틀 */}
      <div className="absolute top-[15px] left-[20px] w-auto">
        <p className="text-lm font-bold text-left text-black mb-1">이번주니어 매장</p>
